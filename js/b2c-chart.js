...
d3.csv("csv/b2c.csv", function (err, data){
    if (err) throw err;

    // year,month,origin,source,blend,roast_level,type,sales,unit_price,monthly_sales
    // 2015,1,Brazil,In Store,Single,dark,Seasonal,12.0,18.536666666666665,303.75
    // 2015,1,Brazil,Online,Single,dark,Evergreen,291.75,24.404404404404385,303.75
    ...
    bubbleChart
        ...
        .radiusValueAccessor(function (p){
            return p.value.monthlySales * 0.2;
        })
